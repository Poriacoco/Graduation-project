...
def load_trained_model():
    ...
    model.load_state_dict(torch.load(f"models/sugar_fold4_week10.pt", map_location='cpu'))
    model.eval()
    return model
...
def explain_model():
    ...
    # plt.figure()
    # shap_sugat.py.summary_plot(mean_shap_values, background_data[:, 0, :], feature_names=feature_names, plot_type="dot")
