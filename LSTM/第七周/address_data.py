...
# # 读取Excel文件
# file_path = "bio_all_34_filtered.xlsx"
# sheets = pd.read_excel(file_path, sheet_name=None)
#
# # 遍历所有工作表
# for sheet_name, df in sheets.items():
...
# # 过滤特征
# def filter_features(file_path = "bio_all_34_with_diff.xlsx"):
#     # 需要删除的原始特征和差值特征列表
#     remove_features = [
#         "碱重kg",  # 原始特征
#         "重量KG",  # 原始特征
...
#
#     # 保存到新Excel文件
#     with pd.ExcelWriter("bio_all_34_filtered.xlsx") as writer:
#         for sheet_name, df in sheets.items():
#             df.to_excel(writer, sheet_name=sheet_name, index=False)